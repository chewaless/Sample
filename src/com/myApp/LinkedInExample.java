...
public class LinkedInExample
{
  ...
  {
	 String authorizationDefaultURL="https://www.linkedin.com/oauth/v2/authorization";

    org.scribe.oauth.OAuthService service = new ServiceBuilder()
                                .provider(LinkedInApi.class)
                                .apiKey("77nlpycj04rzn9")
                                .apiSecret("K87iE57azjh906Q9")
   ...
   // Scanner in = new Scanner(System.in);
    ...
    System.out.println();
    System.out.println(authorizationDefaultURL + requestToken.getToken());
    System.out.println("Now go and authorize Scribe here:");
   // System.out.println(service.getAuthorizationUrl(requestToken));
    System.out.println("And paste the verifier here");
    System.out.print(">>");
    Verifier verifier= new Verifier("client_credentials");
